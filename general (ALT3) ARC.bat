...
--filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media,discord.com,discord.gg --dpi-desync=fake,hostfakesplit --dpi-desync-fake-tls-mod=rnd,dupsid,sni=www.google.com --dpi-desync-hostfakesplit-mod=host=www.google.com,altorder=1 --dpi-desync-fooling=ts --new ^
--filter-tcp=443 --hostlist-domains=discord.com,discord.media,discord.gg --dpi-desync=fake,hostfakesplit --dpi-desync-fake-tls-mod=rnd,dupsid,sni=www.google.com --dpi-desync-hostfakesplit-mod=host=www.google.com,altorder=1 --dpi-desync-fooling=ts --new ^
--filter-udp=443 --hostlist-domains=discord.com,discord.media --dpi-desync=fake --dpi-desync-repeats=6 --new ^
--filter-tcp=443 --ipset="%LISTS%ipset-arc.txt" --dpi-desync=fake --dpi-desync-repeats=3 --dpi-desync-fooling=ts --new ^
--filter-udp=443 --ipset="%LISTS%ipset-arc.txt" --dpi-desync=fake --dpi-desync-repeats=3 --new ^
